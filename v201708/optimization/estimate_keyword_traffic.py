...
def main(client):
  ...
  keywords = [
      {'text': 'data science', 'matchType': 'BROAD'},
  ]
  negative_keywords = [
  ...
  if 'adGroupEstimates' in campaign_estimate:
    ...
    if 'keywordEstimates' in ad_group_estimate:
      ...
      keyword_estimates_and_requests = list(zip(keyword_estimates,
                                           keyword_estimate_requests))
...
if __name__ == '__main__':
  ...
  adwords_client = adwords.AdWordsClient.LoadFromStorage('/Users/Ronessa/Desktop/adwords/googleads.yaml')
